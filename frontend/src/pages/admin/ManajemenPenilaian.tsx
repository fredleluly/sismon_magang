      ...
      <div className="manajemen-card">
        ...
        {loading ? (
          ...
          <div className="empty-state">
            <p>Tidak ada penilaian yang difinalisasi pada bulan {MONTHS[bulan - 1]} {tahun}</p>
          </div>
        ) : (
                ...
                {evaluations.map((evaluation, idx) => {
                  ...
                  return (
                    <tr key={evaluation._id}>
                      <td>{idx + 1}</td>
                      <td className="cell-name">{(user as any)?.name || '-'}</td>
                      ...
                      <td className="cell-center">
                        <strong style={{ color: getGradeColor(evaluation.hasil) }}>
                          {evaluation.hasil}%
                        </strong>
                      </td>
                      <td className="cell-center">
                        <span className="grade-badge" style={{ background: getGradeColor(evaluation.hasil) }}>
                      ...
                      <td className="cell-center">
                        <button
                          ...
                          onClick={() => handleDeleteClick(evaluation._id, (user as any)?.name || 'Unknown')}
        ...
        <div className="modal-overlay" onClick={() => setConfirmModal({ ...confirmModal, show: false })}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <p>
                Anda yakin ingin menghapus penilaian <strong>{confirmModal.userName}</strong>?
              </p>
              <p className="text-muted">
                Penilaian akan direset ke status Draft dan Admin dapat membuat penilaian baru.
              </p>
            </div>
