...
const LaporanKendala: React.FC = () => {
  ...
  const [kategori, setKategori] = useState('Sortir Dokumen');
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-row">
              <div className="form-group"><label>Kategori</label><select value={kategori} onChange={e=>setKategori(e.target.value)}>
                <option>Sortir Dokumen</option><option>Registering</option><option>Melepas Step</option><option>Scanning</option><option>Menyusun ke Kardus</option><option>Stikering</option><option>Sistem</option><option>Lainnya</option>
              </select></div>
