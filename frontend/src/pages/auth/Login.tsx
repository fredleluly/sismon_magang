        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group"><label>Kata Sandi</label>
            <div className="input-wrapper">
              ...
              <button type="button" onClick={() => setShowPassword(!showPassword)} style={{ position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', padding: 4, color: '#94a3b8', display: 'flex', alignItems: 'center' }} title={showPassword ? 'Sembunyikan' : 'Tampilkan'}>
                {showPassword ? (
