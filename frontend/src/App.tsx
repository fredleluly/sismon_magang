...
import SuperManageDataAdmin from './pages/admin/SuperManageDataAdmin';
...
import SuperManage from './pages/admin/SuperManage';
...
const AppRoutes: React.FC = () => {
  ...
  return (
    <Routes>
      {/* Auth routes */}
      <Route path="/login" element={isLoggedIn ? <Navigate to={user?.role === 'admin' || user?.role === 'superadmin' ? '/admin' : '/dashboard'} replace /> : <Login />} />
      <Route path="/register" element={isLoggedIn ? <Navigate to={user?.role === 'admin' || user?.role === 'superadmin' ? '/admin' : '/dashboard'} replace /> : <Register />} />
      ...
      >
        ...
        <Route path="super-manage" element={<SuperManage />} />
        <Route path="super-manage/data-admin" element={<SuperManageDataAdmin />} />
      </Route>
